...
ffmpeg -i 00_testsrc2_tcode_pal.dv -vf lutrgb=g=0:b=0 -target pal-dv 00_testsrc2_tcode_red_pal.dv

ffmpeg -i 00_testsrc2_tcode_pal.dv -vf lutrgb=r=0:b=0 -target pal-dv 00_testsrc2_tcode_green_pal.dv

ffmpeg -i 00_testsrc2_tcode_pal.dv -vf lutrgb=r=0:g=0 -target pal-dv 00_testsrc2_tcode_blue_pal.dv

ffmpeg -i 00_testsrc2_tcode_ntsc.dv -vf lutrgb=g=0:b=0 -target ntsc-dv 00_testsrc2_tcode_red_ntsc.dv

ffmpeg -i 00_testsrc2_tcode_ntsc.dv -vf lutrgb=r=0:b=0 -target ntsc-dv 00_testsrc2_tcode_green_ntsc.dv

ffmpeg -i 00_testsrc2_tcode_ntsc.dv -vf lutrgb=r=0:g=0 -target ntsc-dv 00_testsrc2_tcode_blue_ntsc.dv
