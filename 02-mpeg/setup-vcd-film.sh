...
ffmpeg -i 00_testsrc2_tcode_film.mpg -vf lutrgb=g=0:b=0 -target film-vcd 00_testsrc2_tcode_red_film.mpg

ffmpeg -i 00_testsrc2_tcode_film.mpg -vf lutrgb=r=0:b=0 -target film-vcd 00_testsrc2_tcode_green_film.mpg

ffmpeg -i 00_testsrc2_tcode_film.mpg -vf lutrgb=r=0:g=0 -target film-vcd 00_testsrc2_tcode_blue_film.mpg
...
ffmpeg -i 00_temp_ntsc.dv \
  -vf "drawtext=fontfile=$FONTFILE: \
  fontsize=25: fontcolor=0xFFFFFF: text='%{pts\:hms}-----%{n}': box=1: boxcolor=0x000000@1" \
  -target film-vcd 00_pm5544_tcode_film.mpg
...
ffmpeg -i 00_temp_ntsc.dv \
  -vf "drawtext=fontfile=$FONTFILE: \
  fontsize=25: fontcolor=0xFFFFFF: text='%{pts\:hms}-----%{n}': box=1: boxcolor=0x000000@1" \
  -target film-vcd 00_fubk_tcode_film.mpg
...
ffmpeg -i 00_temp_ntsc.dv \
  -vf "drawtext=fontfile=$FONTFILE: \
  fontsize=25: fontcolor=0xFFFFFF: text='%{pts\:hms}-----%{n}': box=1: boxcolor=0x000000@1" \
  -target film-vcd 00_simple_fubk_tcode_film.mpg
...
ffmpeg -i 00_temp_ntsc.dv \
  -vf "drawtext=fontfile=$FONTFILE: \
  fontsize=25: fontcolor=0xFFFFFF: text='%{pts\:hms}-----%{n}': box=1: boxcolor=0x000000@1" \
  -target film-vcd 00_mlt_timecode_tcode_film.mpg
