...
ffmpeg -f lavfi -i colorchart \
  -vf "drawtext=fontfile=$FONTFILE: \
  fontsize=25: fontcolor=0xFFFFFF: text='%{pts\:hms}-----%{n}': box=1: boxcolor=0x000000@1" \
  -acodec $1 -vcodec $2 -b:v 1000k -s 720x576 -r 25 -frames:v $3 00_colorchart_tcode_pal.mkv

ffmpeg -f lavfi -i colorchart \
  -vf "drawtext=fontfile=$FONTFILE: \
  fontsize=25: fontcolor=0xFFFFFF: text='%{pts\:hms}-----%{n}': box=1: boxcolor=0x000000@1" \
  -acodec $1 -vcodec $2 -b:v 1000k -s 720x480 -r 30000/1001 -frames:v $3 00_colorchart_tcode_ntsc.mkv

ffmpeg -f lavfi -i colorchart \
  -vf "drawtext=fontfile=$FONTFILE: \
  fontsize=25: fontcolor=0xFFFFFF: text='': timecode='00\:00\:00\:00': r=25: box=1: boxcolor=0x000000@1" \
  -acodec $1 -vcodec $2 -b:v 1000k -s 720x576 -r 25 -frames:v $3 00_colorchart_smpte_pal.mkv

ffmpeg -f lavfi -i colorchart \
  -vf "drawtext=fontfile=$FONTFILE: \
  fontsize=25: fontcolor=0xFFFFFF: text='': timecode='00\:00\:00\;00': r=30: box=1: boxcolor=0x000000@1" \
  -acodec $1 -vcodec $2 -b:v 1000k -s 720x480 -r 30000/1001 -frames:v $3 00_colorchart_smpte_ntsc.mkv
