...
ffmpeg -f lavfi -i testsrc=r=25 \
  ...
  fontsize=25: fontcolor=0xFFFFFF: timecode='00\:00\:00\:00': r=25: box=1: boxcolor=0x000000@1" \
  -target pal-dv -frames:v 1000 01-smpte-0000.dv

ffmpeg -f lavfi -i testsrc=r=30000/1001 \
  -vf "drawtext=fontfile=$FONTFILE: \
  fontsize=25: fontcolor=0xFFFFFF: timecode='00\:00\:00\;00': r=30: box=1: boxcolor=0x000000@1" \
