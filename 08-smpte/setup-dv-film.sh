...
ffmpeg -i 00_testsrc2_smpte_film.dv -vf lutrgb=g=0:b=0 -target film-dv 00_testsrc2_smpte_red_film.dv

ffmpeg -i 00_testsrc2_smpte_film.dv -vf lutrgb=r=0:b=0 -target film-dv 00_testsrc2_smpte_green_film.dv

ffmpeg -i 00_testsrc2_smpte_film.dv -vf lutrgb=r=0:g=0 -target film-dv 00_testsrc2_smpte_blue_film.dv
