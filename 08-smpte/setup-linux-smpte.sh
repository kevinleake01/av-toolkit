...
ffmpeg -f lavfi -i smptebars=r=25 \
  ...
  fontsize=25: fontcolor=0xFFFFFF: text='SMPTE ': timecode='00\:00\:00\:00': r=25: box=1: boxcolor=0x000000@1" \
  -target pal-dv -frames:v 1000 01-smptebars-0000.dv

ffmpeg -f lavfi -i smptebars=r=30000/1001 \
  -vf "drawtext=fontfile=$FONTFILE: \
  fontsize=25: fontcolor=0xFFFFFF: text='SMPTE ': timecode='00\:00\:00\;02': r=30: box=1: boxcolor=0x000000@1" \
  -target ntsc-dv -frames:v 1000 01-smptebars-0001.dv

ffmpeg -f lavfi -i smptebars=r=24 \
  -vf "drawtext=fontfile=$FONTFILE: \
  fontsize=25: fontcolor=0xFFFFFF: text='SMPTE ': timecode='00\:00\:00\:00': r=24: box=1: boxcolor=0x000000@1" \
...
ffmpeg -f lavfi -i smptehdbars=r=24 \
  -vf "drawtext=fontfile=$FONTFILE: \
  fontsize=25: fontcolor=0xFFFFFF: text='SMPTE ': timecode='00\:00\:00\:00': r=24: box=1: boxcolor=0x000000@1" \
...
ffmpeg -f lavfi -i madelbrot=r=25 \
  -vf "drawtext=fontfile=$FONTFILE: \
  fontsize=25: fontcolor=0xFFFFFF: text='SMPTE ': timecode='00\:00\:00\:00': r=25: box=1: boxcolor=0x000000@1" \
