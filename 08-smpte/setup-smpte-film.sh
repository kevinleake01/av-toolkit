...
mkdir 00_smpte_film_$1_$2
cd 00_smpte_film_$1_$2
...
ffmpeg -f lavfi -i smptebars=s=640x480:r=24000/1001 \
  ...
  -target film-$1 -frames:v $2 00_smptebars_smpte_film.mpg

ffmpeg -f lavfi -i smptehdbars=s=640x480:r=24000/1001 \
  -vf "drawtext=fontfile=$FONTFILE: \
  fontsize=25: fontcolor=0xFFFFFF: text='': timecode='00\:00\:00\;00': r=24: box=1: boxcolor=0x000000@1" \
  -target film-$1 -frames:v $2 00_smptehdbars_smpte_film.mpg

ffmpeg -f lavfi -i testsrc=s=640x480:r=24000/1001 \
  -vf "drawtext=fontfile=$FONTFILE: \
  fontsize=25: fontcolor=0xFFFFFF: text='': timecode='00\:00\:00\;00': r=24: box=1: boxcolor=0x000000@1" \
  -target film-$1 -frames:v $2 00_testsrc_smpte_film.mpg

ffmpeg -i 00_testsrc_smpte_film.mpg -vf lutrgb=g=0:b=0 -target film-$1 00_testsrc_smpte_red_film.mpg

ffmpeg -i 00_testsrc_smpte_film.mpg -vf lutrgb=r=0:b=0 -target film-$1 00_testsrc_smpte_green_film.mpg

ffmpeg -i 00_testsrc_smpte_film.mpg -vf lutrgb=r=0:g=0 -target film-$1 00_testsrc_smpte_blue_film.mpg

ffmpeg -f lavfi -i mandelbrot=s=640x480:r=24000/1001 \
  -vf "drawtext=fontfile=$FONTFILE: \
  fontsize=25: fontcolor=0xFFFFFF: text='': timecode='00\:00\:00\;00': r=24: box=1: boxcolor=0x000000@1" \
  -target film-$1 -frames:v $2 00_mandelbrot_smpte_film.mpg

ffmpeg -i 00_mandelbrot_smpte_film.mpg -vf lutrgb=g=0:b=0 -target film-$1 00_mandelbrot_smpte_red_film.mpg

ffmpeg -i 00_mandelbrot_smpte_film.mpg -vf lutrgb=r=0:b=0 -target film-$1 00_mandelbrot_smpte_green_film.mpg
...
ffmpeg -f lavfi -i rgbtestsrc=s=640x480:r=24000/1001 \
  -vf "drawtext=fontfile=$FONTFILE: \
  fontsize=25: fontcolor=0xFFFFFF: text='': timecode='00\:00\:00\;00': r=24: box=1: boxcolor=0x000000@1" \
  -target film-$1 -frames:v $2 00_rgbtestsrc_smpte_film.mpg

ffmpeg -f lavfi -i yuvtestsrc=s=640x480:r=24000/1001 \
  -vf "drawtext=fontfile=$FONTFILE: \
  fontsize=25: fontcolor=0xFFFFFF: text='': timecode='00\:00\:00\;00': r=24: box=1: boxcolor=0x000000@1" \
  -target film-$1 -frames:v $2 00_yuvtestsrc_smpte_film.mpg
...
ffmpeg -f lavfi -i sierpinski=s=640x480:type=carpet:r=24000/1001 \
  -vf "drawtext=fontfile=$FONTFILE: \
  fontsize=25: fontcolor=0xFFFFFF: text='': timecode='00\:00\:00\;00': r=24: box=1: boxcolor=0x000000@1" \
  -target film-$1 -frames:v $2 00_sierpinski_carpet_smpte_film.mpg

ffmpeg -f lavfi -i sierpinski=s=640x480:type=triangle:r=24000/1001 \
  -vf "drawtext=fontfile=$FONTFILE: \
  fontsize=25: fontcolor=0xFFFFFF: text='': timecode='00\:00\:00\;00': r=24: box=1: boxcolor=0x000000@1" \
  -target film-$1 -frames:v $2 00_sierpinski_triangle_smpte_film.mpg

ffmpeg -f lavfi -i life=s=640x480:death_color=0x000000:life_color=0xFFFFFF:r=24000/1001 \
  -vf "drawtext=fontfile=$FONTFILE: \
  fontsize=25: fontcolor=0xFFFFFF: text='': timecode='00\:00\:00\;00': r=24: box=1: boxcolor=0x000000@1" \
  -target film-$1 -frames:v $2 00_life_smpte_film.mpg

ffmpeg -f lavfi -i haldclutsrc=8 \
  -vf "drawtext=fontfile=$FONTFILE: \
  fontsize=25: fontcolor=0xFFFFFF: text='': timecode='00\:00\:00\;00': r=24: box=1: boxcolor=0x000000@1" \
  -target film-$1 -frames:v $2 00_haldclutsrc_smpte_film.mpg
