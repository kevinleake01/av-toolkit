...
ffmpeg -i 00_testsrc_smpte_pal.webm -vf lutrgb=g=0:b=0 00_testsrc_smpte_red_pal.webm

ffmpeg -i 00_testsrc_smpte_pal.webm -vf lutrgb=r=0:b=0 00_testsrc_smpte_green_pal.webm

ffmpeg -i 00_testsrc_smpte_pal.webm -vf lutrgb=r=0:g=0 00_testsrc_smpte_blue_pal.webm

ffmpeg -i 00_testsrc_smpte_ntsc.webm -vf lutrgb=g=0:b=0 00_testsrc_smpte_red_ntsc.webm

ffmpeg -i 00_testsrc_smpte_ntsc.webm -vf lutrgb=r=0:b=0 00_testsrc_smpte_green_ntsc.webm

ffmpeg -i 00_testsrc_smpte_ntsc.webm -vf lutrgb=r=0:g=0 00_testsrc_smpte_blue_ntsc.webm
...
ffmpeg -i 00_mandelbrot_smpte_pal.webm -vf lutrgb=g=0:b=0 00_mandelbrot_smpte_red_pal.webm

ffmpeg -i 00_mandelbrot_smpte_pal.webm -vf lutrgb=r=0:b=0 00_mandelbrot_smpte_green_pal.webm

ffmpeg -i 00_mandelbrot_smpte_pal.webm -vf lutrgb=r=0:g=0 00_mandelbrot_smpte_blue_pal.webm

ffmpeg -i 00_mandelbrot_smpte_ntsc.webm -vf lutrgb=g=0:b=0 00_mandelbrot_smpte_red_ntsc.webm

ffmpeg -i 00_mandelbrot_smpte_ntsc.webm -vf lutrgb=r=0:b=0 00_mandelbrot_smpte_green_ntsc.webm

ffmpeg -i 00_mandelbrot_smpte_ntsc.webm -vf lutrgb=r=0:g=0 00_mandelbrot_smpte_blue_ntsc.webm
...
ffmpeg -i 00_testsrc2_smpte_pal.webm -vf lutrgb=g=0:b=0 00_testsrc2_smpte_red_pal.webm

ffmpeg -i 00_testsrc2_smpte_pal.webm -vf lutrgb=r=0:b=0 00_testsrc2_smpte_green_pal.webm

ffmpeg -i 00_testsrc2_smpte_pal.webm -vf lutrgb=r=0:g=0 00_testsrc2_smpte_blue_pal.webm

ffmpeg -i 00_testsrc2_smpte_ntsc.webm -vf lutrgb=g=0:b=0 00_testsrc2_smpte_red_ntsc.webm

ffmpeg -i 00_testsrc2_smpte_ntsc.webm -vf lutrgb=r=0:b=0 00_testsrc2_smpte_green_ntsc.webm

ffmpeg -i 00_testsrc2_smpte_ntsc.webm -vf lutrgb=r=0:g=0 00_testsrc2_smpte_blue_ntsc.webm
